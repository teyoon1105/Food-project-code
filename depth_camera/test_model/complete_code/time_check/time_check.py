    ...
    def main_loop(self):
        ...
        try:
            while True:
                ...
                for result in results:
                    if result.masks is not None:
                        ...
                        for i, mask in enumerate(masks):
                            ...
                            object_name, color = self.cls_name_color.get(self.model.names[int(classes[i])], ("Unknown", (255, 255, 255)))
                            blended_image = self.visualize_results(roi_color, object_name, volume, conf, color, mask_indices, blended_image)
                ...
                print(f"  Depth filtering & Volume: {t10 - t9:.4f} seconds")
                print(f"  Visualization total:  {t12 - t11:.4f} seconds")
